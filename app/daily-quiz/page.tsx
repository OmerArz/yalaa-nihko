        ...
        <Link href="/daily-quiz/words" className="flex-1 min-h-0 block">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 text-xs md:text-sm text-gray-500">בדוק את המילים שלמדת היום</div>
            </div>
          </motion.div>
        </Link>
        ...
        <Link href="/daily-quiz/sentences" className="flex-1 min-h-0 block">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 text-xs md:text-sm text-gray-500">בדוק את המשפטים שלמדת היום</div>
            </div>
          </motion.div>
        </Link>
      </div>
